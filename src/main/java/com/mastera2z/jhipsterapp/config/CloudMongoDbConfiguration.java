...
import com.mastera2z.jhipsterapp.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.mastera2z.jhipsterapp.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.mastera2z.jhipsterapp.config.dbmigrations");
